...
set directory=~/.vim/.vim-tmp    " Where to put swap files.
set backupdir=~/.vim/.vim-backup    " Where... to put backup files? I don't know what makes this different from a swapfile.
...
set undodir=~/.vim/.vim-undo     " Hate having random undo files, so centralize them
